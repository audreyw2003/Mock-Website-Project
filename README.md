...
- **Spotlight Effect**: Animated spotlight circles appear randomly for a cinematic feel.
- **Navigation Menu**: Links to other pages.
- **About Us & Services**: Company mission and offerings.
...
- **Form Fields**:
  ...
  - Information requests (checkboxes for services like film production, post-production, script development).
  - Current role selector (dropdown: Filmmaker, Actor, Student, Writer).
  - Preferred contact date (date picker).
  - Comments (textarea).
- **Form Actions**: Submit via `mailto:` or reset form.
- **Navigation Menu**: Consistent across site.
- **Footer**: Contact info and last modified date.
...
- **Media**: Images, video (`atwork.mp4`), favicon, and linked resources.
...
2. Ensure the following files are present:
   - `index.html` (homepage)
   - `staffdirectory.html` (staff listing)
   - `resources.html` (resources page)
   - `gallery.html` (image gallery)
   - `customerform.html` (contact form)
   - `styles.css` (stylesheet)
   - `favicon.ico` (site icon)
   - `atwork.mp4` (video demo)
   - Image assets (e.g., `filmmakers-2838932_640.jpg`, `camera-2589654_640.jpg`, etc.)
